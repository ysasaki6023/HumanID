...
# CUHK1
last_pid = -1
path = "/home/ysasaki/dataset/CUHK/campus" # this needs to be modified according to your setup
...
# CUHK2
path = "/home/ysasaki/dataset/CUHK/Dataset" # this needs to be modified according to your setup
